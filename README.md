### Debian 13 Trixie / Raspberry Pi OS Trixie / DietPi OS Trixie</br> Package install of Piaware on PC (amd64 / x86_64), and RPi (arm64 / aarch64)</br>Following Pre-built packages for Trixie are available on this site:
